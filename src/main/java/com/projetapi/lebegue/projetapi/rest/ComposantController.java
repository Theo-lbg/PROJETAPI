...
public class ComposantController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Success"), @ApiResponse(responseCode = "500", description = "Internal Server Error")
    })
    @PostMapping()
    ...
    public List<Composant> getComposantsByType(@PathVariable(value="type") String type) {
        return composantRepository.findByType(type);
    }
